...
const getNews = async function(key) {
  try {
    // Load data
    const res = await fetch(`https://newsapi.org/v2/top-headlines?q=${key}&pageSize=${pageSize}&page=${pageNum}&language=en&apiKey=074deb8e504f40409d9fe584df576d4c`)
